...
class Keyboards:
    ...
    @staticmethod
    def get_miss_keyboard():
        """Клавиатура для пропущенных сообщений"""
        keyboard = InlineKeyboardMarkup(
    ...
    def get_size_choice():
        ...
        keyboard = InlineKeyboardMarkup(
            inline_keyboard=[
                [
                    InlineKeyboardButton(text="Стандарт (18см)",
                                         callback_data="size_standard"),
                    InlineKeyboardButton(text="Бенто (14см)",
    ...
    def get_check_keyboard():
        """Проверка заказа - подтверждение или редактирование"""
        keyboard = InlineKeyboardMarkup(
            inline_keyboard=[
                [
                    InlineKeyboardButton(
